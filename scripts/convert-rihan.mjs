...
async function main() {
  console.log("🚀 EXECUTING CONVERSION FOR RIHAN S");
  console.log("=".repeat(70));
  
  const STUDENT_ID = "STU-SU ERV-26-210";
  const CUSTOMER = "RIHAN S";
  const COMPANY = "Smart Up Eraveli";
  const ITEM_CODE = "9th State Tuition Fee";
  const ACADEMIC_YEAR = "2026-2027";
  
  const OLD_SO = "SAL-ORD-2026-01184";
  const OLD_PE = "ACC-PAY-2026-05358";
  const OLD_INVOICES = [
    "ACC-SINV-2026-08740",
    "ACC-SINV-2026-08741",
    "ACC-SINV-2026-08742",
  ...
  const peRefNo = peDetail.reference_no;       // CASH-1780405917044
  ...
  const pePayload = {
    ...
    reference_no: peRefNo,       // CASH-1780405917044
  ...
  console.log("\n" + "=".repeat(70));
  console.log("🎉 CONVERSION COMPLETED SUCCESSFULLY FOR RIHAN S!");
  console.log("=".repeat(70));
  console.log(`Summary:`);

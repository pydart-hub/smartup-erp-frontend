...
async function main() {
  const studentId = "STU-SU FKO-26-056"; // FIDHA P ANS
  console.log(`=== RECONCILING STUDENT: FIDHA P ANS (${studentId}) ===`);

  // 1. Fetch PEs to cancel temporarily
  const peToRecreate = [
    { name: "ACC-PAY-2026-07392", targetInvKey: "ACC-SINV-2026-03835", allocAmount: 3100 },
    { name: "ACC-PAY-2026-08370", targetInvKey: "ACC-SINV-2026-03836", allocAmount: 2000 },
  ];
  ...
  // 2. Re-create Invoices 4..7 with matching payment_schedule
  const invConfigs = [
    { name: "ACC-SINV-2026-03835", dueDate: "2026-07-15", rate: 3100 },
    { name: "ACC-SINV-2026-03836", dueDate: "2026-08-15", rate: 2500 },
    { name: "ACC-SINV-2026-03837", dueDate: "2026-09-15", rate: 2500 },
    { name: "ACC-SINV-2026-03838", dueDate: "2026-10-15", rate: 1000 },
  ];

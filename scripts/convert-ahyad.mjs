...
async function main() {
  console.log("🚀 EXECUTING CONVERSION FOR AHYAD N.B");
  console.log("=".repeat(70));
  
  const STUDENT_ID = "STU-SU ERV-26-209";
  const CUSTOMER = "AHYAD N.B";
  const COMPANY = "Smart Up Eraveli";
  const ITEM_CODE = "8th State Tuition Fee";
  const ACADEMIC_YEAR = "2026-2027";
  
  const OLD_SO = "SAL-ORD-2026-01183";
  const OLD_PE = "ACC-PAY-2026-05356";
  const OLD_INVOICES = [
    "ACC-SINV-2026-08726",
    "ACC-SINV-2026-08728",
    "ACC-SINV-2026-08730",
  ...
  const pePostingDate = peDetail.posting_date; // 2026-06-02
  const pePaidAmount = peDetail.paid_amount;   // 1800
  const peMode = peDetail.mode_of_payment;     // Cash
  const peRefNo = peDetail.reference_no;       // CASH-1780405388621
  ...
  const pePayload = {
    ...
    party_name: CUSTOMER,
    company: COMPANY,
    posting_date: pePostingDate, // 2026-06-02
    mode_of_payment: peMode,     // Cash
    reference_no: peRefNo,       // CASH-1780405388621
  ...
  console.log("\n" + "=".repeat(70));
  console.log("🎉 CONVERSION COMPLETED SUCCESSFULLY FOR AHYAD N.B!");
  console.log("=".repeat(70));
  console.log(`Summary:`);

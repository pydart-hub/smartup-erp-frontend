...
async function main() {
  console.log("🚀 EXECUTING CONVERSION FOR SHEZA NAZISH");
  console.log("=".repeat(70));
  
  const STUDENT_ID = "STU-SU ERV-26-207";
  const CUSTOMER = "SHEZA NAZISH";
  const COMPANY = "Smart Up Eraveli";
  const ITEM_CODE = "9th State Tuition Fee";
  const ACADEMIC_YEAR = "2026-2027";
  
  const OLD_SO = "SAL-ORD-2026-01178";
  const OLD_PE = "ACC-PAY-2026-05348";
  const OLD_INVOICES = [
    "ACC-SINV-2026-08689",
    "ACC-SINV-2026-08690",
    "ACC-SINV-2026-08691",
  ...
  const peRefNo = peDetail.reference_no;       // CASH-1780404458607
  ...
  const pePayload = {
    ...
    reference_no: peRefNo,       // CASH-1780404458607
  ...
  console.log("\n" + "=".repeat(70));
  console.log("🎉 CONVERSION COMPLETED SUCCESSFULLY FOR SHEZA NAZISH!");
  console.log("=".repeat(70));
  console.log(`Summary:`);

...
async function main() {
  console.log("🚀 EXECUTING CONVERSION FOR ASHNA NOURIN P.F");
  console.log("=".repeat(70));
  
  const STUDENT_ID = "STU-SU ERV-26-213";
  const CUSTOMER = "ASHNA NOURIN P.F";
  const COMPANY = "Smart Up Eraveli";
  const ITEM_CODE = "9th State Tuition Fee";
  const ACADEMIC_YEAR = "2026-2027";
  
  const OLD_SO = "SAL-ORD-2026-01191";
  const OLD_PE = "ACC-PAY-2026-05366";
  const OLD_INVOICES = [
    "ACC-SINV-2026-08788",
    "ACC-SINV-2026-08789",
    "ACC-SINV-2026-08790",
  ...
  const peRefNo = peDetail.reference_no;       // CASH-1780409267456
  ...
  const pePayload = {
    ...
    reference_no: peRefNo,       // CASH-1780409267456
  ...
  console.log("\n" + "=".repeat(70));
  console.log("🎉 CONVERSION COMPLETED SUCCESSFULLY FOR ASHNA NOURIN P.F!");
  console.log("=".repeat(70));
  console.log(`Summary:`);

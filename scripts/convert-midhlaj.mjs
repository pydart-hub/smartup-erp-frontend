...
async function main() {
  console.log("🚀 EXECUTING CONVERSION FOR MIDHLAJ M.S");
  console.log("=".repeat(70));
  
  const STUDENT_ID = "STU-SU ERV-26-208";
  const CUSTOMER = "MIDHLAJ M.S";
  const COMPANY = "Smart Up Eraveli";
  const ITEM_CODE = "8th State Tuition Fee";
  const ACADEMIC_YEAR = "2026-2027";
  
  const OLD_SO = "SAL-ORD-2026-01181";
  const OLD_PE = "ACC-PAY-2026-05352";
  const OLD_INVOICES = [
    "ACC-SINV-2026-08716",
    "ACC-SINV-2026-08717",
    "ACC-SINV-2026-08718",
  ...
  const pePaidAmount = peDetail.paid_amount;   // 1500
  const peMode = peDetail.mode_of_payment;     // Cash
  const peRefNo = peDetail.reference_no;       // CASH-1780405209347
  ...
  // Step 5: Re-create & Submit Payment Entry (1500 total: 1450 to Inst 1, 50 to Inst 2)
  ...
  const pePayload = {
    ...
    reference_no: peRefNo,       // CASH-1780405209347
    reference_date: pePostingDate,
    paid_amount: pePaidAmount,   // 1500
  ...
  console.log(`  ✓ Created & Submitted PE (${createdPE.name}): ₹1,500 (₹1,450 to Inst 1, ₹50 to Inst 2)`);
  ...
  console.log("\n" + "=".repeat(70));
  console.log("🎉 CONVERSION COMPLETED SUCCESSFULLY FOR MIDHLAJ M.S!");
  console.log("=".repeat(70));
  console.log(`Summary:`);
  ...
  console.log(`  PE: ${createdPE.name} (₹1,500 on ${pePostingDate})`);
}

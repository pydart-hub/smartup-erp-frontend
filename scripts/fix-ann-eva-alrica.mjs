...
async function main() {
  const studentId = "STU-SU FKO-26-057"; // ANN EVA ALRICA
  console.log(`=== RECONCILING STUDENT: ANN EVA ALRICA (${studentId}) ===`);

  // 1. Fetch PEs to cancel temporarily
  const peToRecreate = [
    { name: "ACC-PAY-2026-07010", targetInvKey: "ACC-SINV-2026-03882", allocAmount: 200 },
    { name: "ACC-PAY-2026-08554", targetInvKey: "ACC-SINV-2026-03883", allocAmount: 2500 },
    { name: "ACC-PAY-2026-08555", targetInvKey: "ACC-SINV-2026-03884", allocAmount: 1500 },
  ];
  ...
  // 2. Re-create Invoices 5..8 with matching payment_schedule
  const invConfigs = [
    { name: "ACC-SINV-2026-03882", dueDate: "2026-08-15", rate: 200 },
    { name: "ACC-SINV-2026-03883", dueDate: "2026-09-15", rate: 2500 },
    { name: "ACC-SINV-2026-03884", dueDate: "2026-10-15", rate: 2500 },
    { name: "ACC-SINV-2026-03885", dueDate: "2026-11-15", rate: 600 },
  ];
  ...
  // 4. Verification
  console.log("\n=== VERIFICATION FOR ANN EVA ALRICA ===");

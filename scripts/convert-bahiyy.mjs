...
async function main() {
  console.log("🚀 EXECUTING CONVERSION FOR BAHIYY AL DIN KA");
  console.log("=".repeat(70));
  
  const STUDENT_ID = "STU-SU ERV-26-214";
  const CUSTOMER = "BAHIYY AL DIN KA";
  const COMPANY = "Smart Up Eraveli";
  const ITEM_CODE = "9th State Tuition Fee";
  const ACADEMIC_YEAR = "2026-2027";
  
  const OLD_SO = "SAL-ORD-2026-01196";
  const OLD_PE = "ACC-PAY-2026-05372";
  const OLD_INVOICES = [
    "ACC-SINV-2026-08828",
    "ACC-SINV-2026-08829",
    "ACC-SINV-2026-08830",
  ...
  const peRefNo = peDetail.reference_no;       // CASH-1780411012175
  ...
  const pePayload = {
    ...
    reference_no: peRefNo,       // CASH-1780411012175
  ...
  console.log("\n" + "=".repeat(70));
  console.log("🎉 CONVERSION COMPLETED SUCCESSFULLY FOR BAHIYY AL DIN KA!");
  console.log("=".repeat(70));
  console.log(`Summary:`);

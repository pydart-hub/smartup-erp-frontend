...
const DEMO_PARENT_NAV = [
  ...
  { label: "Children", href: "/demo/parent/children", icon: Baby },
  { label: "Performance", href: "/demo/parent/performance", icon: TrendingUp },
  { label: "Attendance", href: "/demo/parent/attendance", icon: ClipboardCheck },
  { label: "Video Classes", href: "/demo/parent/video-classes", icon: Video },
  { label: "Fees", href: "/demo/parent/fees", icon: IndianRupee },
  { label: "Complaints", href: "/demo/parent/complaints", icon: MessageSquareWarning },
];

export default function DemoParentLayout({ children }: { children: React.ReactNode }) {

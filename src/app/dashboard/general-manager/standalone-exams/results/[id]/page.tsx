...
export default async function StudentResultDetailPage({ params }: PageProps) {
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto space-y-6 text-slate-800">
      {/* Back navigation */}
      <Link
        href="/dashboard/general-manager/standalone-exams/results"
      ...
      <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm space-y-4 relative">
        ...
        <h3 className="text-lg font-bold text-slate-950">{aiSummary.headline}</h3>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-4">
          {results.questions.map((q, idx) => {
            ...
            return (
              <div key={q.questionId} className="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm space-y-4">

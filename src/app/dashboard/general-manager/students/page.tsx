...
function BranchCard({ branch }: { branch: { name: string; abbr: string } }) {
  ...
  return (
    <Link href={`/dashboard/general-manager/branches/${encodeURIComponent(branch.name)}/students`}>
      <motion.div
...
// ── Main Page ──
export default function GeneralManagerStudentsPage() {
  ...
  return (
    ...
    >
      ...
      <motion.div variants={itemVariants} className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <Link href="/dashboard/general-manager/students/all">

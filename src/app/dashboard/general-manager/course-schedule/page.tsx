...
import {
  Building2, CalendarDays, ChevronRight, UserCheck,
} from "lucide-react";
...
export default function GMCourseSchedulePage() {
  ...
  const overallClassesDone = branches.length
            ...
            <motion.div variants={container} initial="hidden" animate="show" className="grid grid-cols-2 sm:grid-cols-3 gap-3">
              ...
              <motion.div variants={item} className="bg-surface rounded-[12px] p-4 border border-border-light">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-xs text-text-tertiary font-medium">Total Batches</span>
                </div>
                <p className="text-2xl font-bold text-primary">{totalBatches}</p>
              </motion.div>
              <motion.div variants={item} className="bg-surface rounded-[12px] p-4 border border-border-light">
                <div className="flex items-center gap-2 mb-2">
                ...
                <p className={`text-2xl font-bold ${pctColor(overallClassesDone, 80, 60)}`}>{overallClassesDone}%</p>
              </motion.div>
            </motion.div>

// GM Work Assignments Listing Page
// File: src/app/dashboard/general-manager/work-assignments/page.tsx
...
export default function GMWorkAssignmentsPage() {
    ...
    <div className="space-y-6 pb-12">
      ...
      <div>
        ...
        <p className="text-text-secondary mt-2">
          Create, manage, and review work assignments for instructors
        </p>
      </div>
      ...
      {/* Main List */}
      <WorkAssignmentList onStatsChange={handleStatsChange} />
    </div>
  );
}

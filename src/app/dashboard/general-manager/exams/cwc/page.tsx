...
export default function GMCwcExamsPage() {
  ...
  const cards = [
    {
      ...
      href: "/dashboard/general-manager/exams/cwc/list?group=CWC Exam 1",
      icon: Coffee,
    ...
    },
    {
      ...
      href: "/dashboard/general-manager/exams/cwc/list?group=CWC Exam 2",
      icon: Coffee,
      videoSrc: "/Logo Icon Smile ALPHA.webm",
    ...
    },
    {
      ...
      href: "/dashboard/general-manager/exams/cwc/list?group=CWC Exam 3",
      icon: Coffee,
      videoSrc: "/Logo Icon Smile ALPHA.webm",
    ...
    },
    {
      ...
      href: "/dashboard/general-manager/exams/cwc/list?group=all",
      icon: CheckCircle2,

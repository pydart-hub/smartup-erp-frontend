...
export default async function GMDiagnosisExamsPage() {
      ...
      <section className="space-y-4">
        ...
        <div className="grid gap-4 md:grid-cols-3">
          {data.classSummaries.map((item) => (
            <Link key={item.levelCode} href={`/dashboard/general-manager/exams/diagnosis/${item.levelCode}`} className="block">

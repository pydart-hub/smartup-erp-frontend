...
function AdmitPageContent() {
  ...
  // Pre-select branch when defaultCompany loads (but don't lock — Sales User can change it)
  useEffect(() => {
  ...
  const feeProgram = useMemo(() => selectedProgram ?? "", [selectedProgram]);
        ...
        <Card>
          <CardContent className="p-6">
            <AnimatePresence mode="wait">
              ...
              {/* Step 3: Academic Details — branch is locked */}
              {currentStep === 3 && (
                <motion.div
                  key="step3"
                  initial={{ opacity: 0, x: 20 }}
                ...
                >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    {/* Branch — free select, pre-selected to defaultCompany if available */}

...
export default function DirectorMentorLeaderboardPage() {
  ...
  const { data, isLoading, isFetching, error } = useQuery({
    queryKey: ["director-mentor-summary", branchParam],
    queryFn: () => getDirectorMentorSummary(branchParam === "all" ? undefined : branchParam),
    staleTime: 60_000,
    ...
    <div className="space-y-6 max-w-5xl mx-auto pb-10">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="space-y-1">
          <Link
            href="/dashboard/director/leaderboard"
            ...
            {TABS.map((t) => {
              ...
              return (
                ...
                >
                  {isActive && (
                    <motion.span
                      layoutId="activeTabMentorDirector"

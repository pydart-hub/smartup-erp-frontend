...
export default async function DirectorDiagnosisClassReportPage({
  searchParams,
}: PageProps) {
    ...
    return (
      <div className="p-4 lg:p-6 max-w-7xl mx-auto">
        <DiagnosisExamsClassReport
          ...
          backUrl="/dashboard/director/diagnosis-exams"
        />
      </div>
    );
  } catch (error) {
    console.error("Database connection error in Diagnosis Exams Class Report (Director):", error);

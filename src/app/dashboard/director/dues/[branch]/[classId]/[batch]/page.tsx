...
async function exportBatchStudentsExcel(
  ...
  const sanitizedSheetName = `${batchName.replace(/[\\/*?:[\]]/g, "_").slice(0, 25)} Fees`;
  ...
  subCell.value = `Branch: ${branchName}   |   Batch: ${batchName}   |   Generated: ${todayFormatted}   |   Total Students: ${students.length}   |   Report exported from ERP`;

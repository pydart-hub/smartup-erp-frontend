    ...
    <div className="mx-auto max-w-7xl space-y-6 p-4 sm:p-6">
      <div className="flex items-center justify-between gap-3 flex-wrap">
        <div>
          <div className="flex items-center gap-2">
            <Link href={`/dashboard/branch-manager/level-exams/${levelCode}`}>
            ...
            <div>
              ...
              <h1 className="mt-1 text-3xl font-bold text-text-primary">{branchName} - {decodedSubject}</h1>
            </div>
          </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Diagnosis exam marks, attempt count, best percentage, and latest exam indicator for {branchName}.
          </CardDescription>
        </CardHeader>

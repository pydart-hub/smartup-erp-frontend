              ...
              {data.guardians.length === 0 ? (
                ...
                data.guardians.map((row, index) => (
                  <div
                    ...
                    className="rounded-[24px] border border-slate-200/80 bg-[linear-gradient(180deg,rgba(255,255,255,0.95),rgba(243,249,247,0.95))] p-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.9),0_16px_30px_-26px_rgba(103,58,183,0.45)]"
                  >
    ...
    <Card className="overflow-hidden border border-slate-200/70 bg-[linear-gradient(180deg,rgba(255,255,255,0.96),rgba(243,248,250,0.94))] shadow-[0_28px_50px_-32px_rgba(15,23,42,0.42)]">
      <CardHeader className="flex flex-row items-center justify-between gap-3 pb-3">
        <div className="flex items-center gap-2">
          <span className="flex h-9 w-9 items-center justify-center rounded-2xl bg-[linear-gradient(135deg,rgba(103,58,183,0.12),rgba(130,195,91,0.2))] text-primary shadow-[inset_0_1px_0_rgba(255,255,255,0.85)]">
            {icon}
          </span>

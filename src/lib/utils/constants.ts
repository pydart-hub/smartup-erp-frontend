...
export const DIRECTOR_NAV: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: "Alumni Connect", href: "/dashboard/director/alumni", icon: "Users", emoji: "🎓" },
      { label: "A+ Cabinet", href: "/dashboard/director/academics/students", icon: "GraduationCap", emoji: "🏆" },
    ],
  },
...
export const HR_MANAGER_NAV: NavItem[] = [
  ...
  { label: "Report", href: "/dashboard/hr-manager/report", icon: "FileBarChart", emoji: "📈" },
];

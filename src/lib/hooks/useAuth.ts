...
export function useAuth() {
  ...
  async function login(credentials: LoginCredentials) {
    ...
    const APP_ROLES = ["Director", "Management", "Academic Planning Dept", "Curriculum Dept", "General Manager", "Branch Manager", "Mentor", "HR Manager", "Administrator", "Instructor", "Batch Coordinator", "Teacher", "Sales User", "Content Admin", "Accounts User", "Parent"];

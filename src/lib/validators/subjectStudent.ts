...
export const subjectStudentSchema = z.object({
  ...
  // Step 3 — Academic + Subject
  custom_branch: z.string().min(1, "Branch is required"),
  level: z.string().min(1, "Level is required"),
  subject: z.string().min(1, "Subject is required"),
  program: z.string().min(1, "HSS program is required"),
...
export type SubjectStudentFormValues = z.infer<typeof subjectStudentSchema>;

...
import type { AttendanceClassDetailData } from "@/lib/reports/summary-types";

async function fetchData(
  program: string,
  fromDate?: string,
  toDate?: string,
): Promise<AttendanceClassDetailData> {
...
export function AttendanceClassDetail({ program, fromDate, toDate, onBack }: Props) {
  const [loading, setLoading] = useState<"xlsx" | "csv" | null>(null);
  const { data, isLoading, isError } = useQuery({
    queryKey: ["report-attendance", "class", program, fromDate, toDate],

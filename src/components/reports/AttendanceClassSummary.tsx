...
import type { AttendanceClassRow } from "@/lib/reports/summary-types";
...
export function AttendanceClassSummary({ fromDate, toDate, onDrillDown }: Props) {
  const [loading, setLoading] = useState<"xlsx" | "csv" | null>(null);
  const { data: rows, isLoading, isError } = useQuery({
    queryKey: ["report-attendance", "class", "all", fromDate, toDate],

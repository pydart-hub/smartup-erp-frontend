                    ...
                    {methodSubStep === "selection" && (
                      <div className="space-y-3.5">
                        ...
                        <button
                          ...
                          className="w-full text-left p-5 rounded-2xl border border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900/10 hover:border-violet-500/50 hover:shadow-[0_8px_30px_rgba(124,58,237,0.04)] transition-all duration-200 flex items-center gap-4 group"
                        >
                          <div className="w-12 h-12 rounded-xl bg-violet-50 dark:bg-violet-950/35 flex items-center justify-center text-violet-600 dark:text-violet-400 group-hover:scale-105 transition-transform duration-200">
                        ...
                        {allowOffline && (
                          ...
                          >
                            <div className="w-12 h-12 rounded-xl bg-green-50 dark:bg-green-950/35 flex items-center justify-center text-green-600 dark:text-green-400 group-hover:scale-105 transition-transform duration-200">

...
async function run() {
  ...
  const basicSchedule = [
    { label: "Inst 1", amount: 2500, postingDate: "2026-06-03", dueDate: "2026-06-03" },
    { label: "Inst 2", amount: 2500, postingDate: "2026-06-03", dueDate: "2026-07-03" },
    { label: "Inst 3", amount: 2500, postingDate: "2026-06-03", dueDate: "2026-08-03" },
    { label: "Inst 4", amount: 2500, postingDate: "2026-06-03", dueDate: "2026-09-03" },
    { label: "Inst 5", amount: 2500, postingDate: "2026-06-03", dueDate: "2026-10-03" },
    { label: "Inst 6", amount: 2500, postingDate: "2026-06-03", dueDate: "2026-11-03" },
    { label: "Inst 7", amount: 2500, postingDate: "2026-06-03", dueDate: "2026-12-03" },
    { label: "Inst 8", amount: 1500, postingDate: "2026-06-03", dueDate: "2027-01-03" },
  ];

  console.log("\n--- Creating & Submitting 8 Basic Invoices with explicit payment_schedule ---");
  const newInvoices = [];

...
- [x] Stage and commit local modifications
- [x] Push local changes to GitHub repository
- [x] SSH to server and run clustered deployment commands
- [x] Verify all 4 instances (`smartup-erp-1` to `smartup-erp-4`) on the server
- [x] Verify Nginx load balancing upstream and SSL
